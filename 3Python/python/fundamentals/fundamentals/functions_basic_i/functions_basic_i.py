...
# => 3, 5, 8
# => It got me, I overlooked the missing return
# => 3, 5, ... TypeError: unsupported operand type(s) for +: 'NoneType' and 'NoneType'
...
print(number_of_days_in_a_week_silicon_or_triangle_sides(2, 3) +
      number_of_days_in_a_week_silicon_or_triangle_sides(5, 3))  # => 21
