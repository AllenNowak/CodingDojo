# Reworked User assignment where each method returns self
...
john_doe = User('john', 'doe', 'jdoe@aol.com', 66).display_info()
...
junior_doe.spend_points(40).display_info()
